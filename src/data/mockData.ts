...
import momDayAssortedPastries from '../../public/MothersDay/momDayAssortedPastries.jpg';
import cheesecakeMuffins from '../../public/MothersDay/cheesecakeMuffins.jpg';
import cheesecakeMuffins2 from '../../public/MothersDay/cheesecakeMuffins2.jpg';
import maryKitchen2 from '../../public/MothersDay/mary-kitchen2.jpg';
import maryKitchen3 from '../../public/MothersDay/mary-kitchen3.jpg';
import mothersDayPastries from '../../public/MothersDay/mothersDayPastries.jpg';
import mothersDayPastries2 from '../../public/MothersDay/mothersDayPastries2.jpg';
...
export const galleryItems: GalleryItem[] = [
  {
    ...
    category: "Cakes",
    description:
      "A delightful strawberry cake with fresh strawberries and whipped cream.",
    featured: true,
  },
  {
    id: "2",
    ...
    category: "Pastries",
    description:
      "Beautiful heart-shaped macarons filled with raspberry ganache.",
    featured: false,
  },
  {
    id: "3",
    ...
    featured: false,
    description:
      "A selection of flaky pastries including Donuts and Cinnamon rolls.",
  },
  {
    id: "4",
    src: birthDayCake,
  ...
  },
  {
    ...
    category: "Custom Orders",
    description:
      "Beautifully decorated Easter-themed cookies, perfect for celebrations.",
    featured: true,
  },
  {
    id: "9",
  ...
  },
  {
    ...
    category: "Breads",
    description:
      "Flaky, buttery croissants made from scratch using traditional techniques.",
    featured: true,
  },
  {
    id: "16",
  ...
  },
  {
    ...
    category: "Cakes",
    description:
      "Elegant multi-tiered wedding cake with intricate decorations.",
    featured: true,
  },
  {
    id: "23",
  ...
  {
    id: "24",
    src: momDayAssortedPastries,
    alt: "Assorted Pastries",
    category: "Mother's Day",
    description: "Assorted pastries for Mother's Day.",
    featured: true,
  },
  {
    id: "25",
    src: cheesecakeMuffins,
    alt: "Cheesecake Muffins",
    category: "Pastries",
    description: "Cheesecake muffins arranged on display.",
    featured: false,
  },
  {
    id: "26",
    src: cheesecakeMuffins2,
    alt: "Cheesecake Muffins Close-up",
    category: "Pastries",
    description: "Close-up of cheesecake muffins.",
    featured: false,
  },
  {
    id: "27",
    src: maryKitchen2,
    alt: "Chef Mary in Kitchen",
    category: "Behind the Scenes",
    description: "Chef Mary in the kitchen preparing pastries.",
    featured: false,
  },
  {
    id: "28",
    src: maryKitchen3,
    alt: "Chef Mary Decorating Cookies",
    category: "Behind the Scenes",
    description: "Chef Mary working on heart-shaped cookies.",
    featured: false,
  },
  {
    id: "29",
    src: mothersDayPastries,
    alt: "Heart Cookies",
    category: "Mother's Day",
    description: "Heart-shaped cookies with MOM written on them.",
    featured: true,
  },
  {
    id: "30",
    src: mothersDayPastries2,
    alt: "Assorted Desserts",
    category: "Pastries",
    description: "Pastries and desserts on a wooden board.",
    featured: false,
  },
];
